...
def write_animation_for_node_split_keys(io, node)
  ...
  times.each_with_index do |tsec, i|
    ...
    io.puts "      #{to_ticks(tsec)};4;#{w}, #{x}, #{y}, #{z};;"
  end
  io.puts "    }"
  ...
  times.each_with_index do |tsec, i|
    ...
    io.puts "      #{to_ticks(tsec)};3;#{fmt_f(sx)}, #{fmt_f(sy)}, #{fmt_f(sz)};;"
  end
  io.puts "    }"
  ...
  times.each_with_index do |tsec, i|
    ...
    io.puts "      #{to_ticks(tsec)};3;#{fmt_f(tx)}, #{fmt_f(ty)}, #{fmt_f(tz)};;"
  end
  io.puts "    }"
